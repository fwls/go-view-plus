      ...
      <n-scrollbar style="max-height: 718px">
        <div class="go-pr-3">
          <n-space vertical>
            ...
            <data-source-target-config :target-data-request="targetData?.request"></data-source-target-config>
          </n-space>
        </div>
      </n-scrollbar>
      <!-- 底部 -->
...
import { DataSourceTargetConfig } from './components/DataSourceTargetConfig'
