...
const importPath = {
  ...
  'PageEnum.BASE_HOME_DATASOURCE_NAME': () => import('@/views/project/dataSource/index.vue')
}
...
const projectRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    {
      path: PageEnum.BASE_HOME_DATASOURCE,
      name: PageEnum.BASE_HOME_DATASOURCE_NAME,
      component: importPath['PageEnum.BASE_HOME_DATASOURCE_NAME'],
      meta: {
        title: '数据源'
      }
    },
